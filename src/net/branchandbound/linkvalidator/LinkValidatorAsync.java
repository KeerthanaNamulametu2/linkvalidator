...
public class LinkValidatorAsync {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var futures=Files.lines(Path.of("C:\\Users\\keerthana_careeco\\Downloads\\java-fundamentals-httpclient\\03\\demos\\after\\linkvalidator\\urls.txt"))
...
//        }
        return client.sendAsync(request,HttpResponse.BodyHandlers.discarding() ).thenApply(LinkValidatorAsync::responseToString).exceptionally(e -> String.format("%s -> %s", link, false));
    }
